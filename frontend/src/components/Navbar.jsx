...
const navigation = [
  ...
  { name: "FIND A CRUISE", href: "#", current: false },
  { name: "BOATS", href: "#", current: false },
...
export default function Home() {
 ...
 const logout = async(req,res)=>{
  ...
  return (
    <Disclosure as="nav" className="bg-cyan-500 bg-opacity-50 backdrop-filter backdrop-blur">
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <img
                    className="block h-24 w-auto lg:hidden mt-6"
                    src="src/assets/sailmate-removebg-preview.png"
                    alt="SailMate"
                  />
                  <img
                    className="hidden h-20 w-auto lg:block mt-3"
                    src="src/assets/sailmate-removebg-preview.png"
                    alt="SailMate"
                  />
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <button
                  type="button"
                  className="rounded-full p-1 text-white hover:text-white"
                >
                ...
                <Link className="text-white ml-2" to={'/login'}>Login</Link>
                </>)}
              </div>
            </div>
          </div>
